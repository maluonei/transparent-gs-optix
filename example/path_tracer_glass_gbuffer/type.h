...
struct OptixLaunchParams {
    ...
    cuda::RWArrayView<float4> reflect_buffer;
    cuda::RWArrayView<float4> reflect_position_buffer;
    cuda::RWArrayView<float4> refract_buffer;
    cuda::RWArrayView<float4> refract_position_buffer;
    //cuda::RWArrayView<float> fresnel_buffer;
